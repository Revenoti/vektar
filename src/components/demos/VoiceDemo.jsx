    ...
    return (
      <div className="space-y-4 md:space-y-6">
        <div className="text-center mb-4 md:mb-6">
          <h3 className="text-lg md:text-xl font-semibold mb-2">Voice Receptionist Demo</h3>
            ...
            <CardContent className="p-4 md:p-6">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div className="flex items-center space-x-3 md:space-x-4">
                  <div className="w-10 h-10 md:w-12 md:h-12 bg-gradient-to-br from-green-500 to-emerald-500 rounded-full flex items-center justify-center flex-shrink-0">
                    <Phone className="w-5 h-5 md:w-6 md:h-6 text-white" />
                  </div>
                  <div className="min-w-0 flex-1">
                    <h4 className="font-semibold text-sm md:text-base">{scenario.title}</h4>
                    <div className="flex flex-col md:flex-row md:items-center md:space-x-4 text-xs md:text-sm text-muted-foreground mt-1">
                      <span className="flex items-center">
                        <User className="w-3 h-3 md:w-4 md:h-4 mr-1" />
                        <span className="truncate">{scenario.caller}</span>
                      </span>
                      <span className="flex items-center">
                ...
                <Button
                  ...
                  className="vectorik-gradient hover-glow w-full md:w-auto min-h-[44px] md:min-h-[auto]"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
              <div className="space-y-2 md:space-y-3">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-xs md:text-sm">Natural language processing</span>
                </div>
                <div className="flex items-center space-x-2">
                  <div className="w-2 h-2 bg-primary rounded-full flex-shrink-0"></div>
                  <span className="text-xs md:text-sm">Appointment scheduling</span>
                </div>
                <div className="flex items-center space-x-2">
                  <div className="w-2 h-2 bg-primary rounded-full flex-shrink-0"></div>
                  <span className="text-xs md:text-sm">Call routing & escalation</span>
                </div>
              </div>
              <div className="space-y-2 md:space-y-3">
                <div className="flex items-center space-x-2">
                  <div className="w-2 h-2 bg-primary rounded-full flex-shrink-0"></div>
                  <span className="text-xs md:text-sm">24/7 availability</span>
                </div>
                <div className="flex items-center space-x-2">
                  <div className="w-2 h-2 bg-primary rounded-full flex-shrink-0"></div>
                  <span className="text-xs md:text-sm">CRM integration</span>
                </div>
                <div className="flex items-center space-x-2">
                  <div className="w-2 h-2 bg-primary rounded-full flex-shrink-0"></div>
                  <span className="text-xs md:text-sm">Multi-language support</span>
                </div>
              </div>
            </div>
          </CardContent>
    ...
    <div className="space-y-4 md:space-y-6">
      ...
      <Card className="glass-card">
        <CardContent className="p-4 md:p-6">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div className="flex items-center space-x-3 md:space-x-4">
              <div className="w-10 h-10 md:w-12 md:h-12 bg-gradient-to-br from-green-500 to-emerald-500 rounded-full flex items-center justify-center animate-pulse flex-shrink-0">
                <PhoneCall className="w-5 h-5 md:w-6 md:h-6 text-white" />
              </div>
              <div className="min-w-0 flex-1">
                <h3 className="font-semibold text-sm md:text-base">{currentCall.title}</h3>
            ...
            <div className="flex items-center justify-between md:justify-end space-x-2">
              ...
              <Button variant="outline" size="sm" onClick={endCall} className="min-h-[36px] md:min-h-[auto]">
                End Call
              </Button>
            </div>
          </div>
          ...
          <div className="flex items-center justify-center space-x-2 md:space-x-4">
            <Button
              ...
              size="sm"
              onClick={resetCall}
              className="min-h-[44px] min-w-[44px] md:min-h-[auto] md:min-w-[auto] px-2 md:px-3"
            >
              <RotateCcw className="w-4 h-4" />
            </Button>
            <Button
              onClick={togglePlayPause}
              className="vectorik-gradient hover-glow min-h-[44px] px-4 md:px-6"
            >
              {isPlaying ? (
      ...
      <Card className="glass-card">
        <CardContent className="p-4 md:p-6">
          <h4 className="font-semibold mb-3 md:mb-4 text-sm md:text-base">Live Conversation</h4>
          <div className="space-y-3 md:space-y-4 max-h-80 md:max-h-96 overflow-y-auto">
            {currentCall.steps.map((step, index) => (
              <div
                key={index}
                className={`flex items-start space-x-2 md:space-x-3 transition-all duration-500 ${
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs md:text-sm bg-secondary/50 rounded-lg p-2 md:p-3 leading-relaxed">
                    {step.text}
                  </p>
                </div>
              </div>
      ...
      <Card className="glass-card">
        <CardContent className="p-4 md:p-6">
          <h4 className="font-semibold mb-3 md:mb-4 text-sm md:text-base">Real-time Analytics</h4>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
            <div className="text-center">
              <div className="text-xl md:text-2xl font-bold text-primary">0.3s</div>
              <div className="text-xs text-muted-foreground">Response Time</div>
            </div>
            <div className="text-center">
              <div className="text-xl md:text-2xl font-bold text-green-500">98%</div>
              <div className="text-xs text-muted-foreground">Accuracy</div>
            </div>
            <div className="text-center">
              <div className="text-xl md:text-2xl font-bold text-blue-500">95%</div>
              <div className="text-xs text-muted-foreground">Satisfaction</div>
            </div>
            <div className="text-center">
              <div className="text-xl md:text-2xl font-bold text-purple-500">Auto</div>
